...
function PersonNodeComponent({ data }: NodeProps) {
  ...
  return (
    <>
      ...
      <div
        className={`flex items-center gap-3 rounded-lg border-2 ${borderColor} bg-card p-3 shadow-sm min-w-[180px] cursor-pointer hover:shadow-md transition-shadow`}
      >
